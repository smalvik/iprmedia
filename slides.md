...
| 2. УМК | **7** | Понимаю ФГОС→ОПОП→РПД, нюансы СПО — через CustDev |
| 3. Практика | **8** | Конструктор курсов с практикой в LMS |
| 4. Монетизация | **8** | B2B: FTE-оценка кастомов, коробочная поставка, retention/апселл |
...
**Сильные:** tech, EdTech, AI, data-driven, опыт миграций | Быстро погружаюсь через CustDev и работу с клиентами
